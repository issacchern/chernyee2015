...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global: { href: 'css/style2.css', containers: '45em', grid: { gutters: { vertical: '2em', horizontal: 0 } } },
			...
			medium: { media: '(max-width: 1024px)', href: 'css/style-medium2.css', containers: '85%', grid: { collapse: 1 } },
